...
- (LFLiveSession *)session {
    if (!_session) {
        ...
        */
        ...
        pathToMovie = [NSHomeDirectory() stringByAppendingPathComponent:@"Documents/Movie.mp4"];
    ...
    if (!_startLiveButton) {
        ...
        [_startLiveButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id sender) {
            ...
            if (_self.startLiveButton.selected) {
                [_self.startLiveButton setTitle:@"Broadcasting..." forState:UIControlStateNormal];
                LFLiveStreamInfo *stream = [LFLiveStreamInfo new];
                stream.url = @"rtmp://messaging.goldenspear.com/live/osama";
